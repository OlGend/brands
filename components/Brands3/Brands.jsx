...
import { getBrands } from "@/components/getBrands3";
import { useBrand } from "@/components/Brands3/BrandContext";
  ...
  const updateBrands = async () => {
    ...
    try {
      const response = await fetch(
        "https://pickbonus.myawardwallet.com/api/brandsNew3/rebrand.php",
        {
          method: "POST",
        }
      );
