...
export const getBrands = async (y) => {
  const apiOld = "https://pickbonus.myawardwallet.com/api/brandsNew/read_sheet.php";
  const apiNew = "https://pickbonus.myawardwallet.com/api/brandsNew/read_sheet.php";
